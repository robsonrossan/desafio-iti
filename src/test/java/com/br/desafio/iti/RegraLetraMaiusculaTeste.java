...
@SpringBootTest
public class RegraLetraMaiusculaTeste {
	...
	@Test
	public void verificarSenhaComAoMenosUmaLetraMaiusculaValidaControllerTesteValido() {
	...
	@Test
	public void verificarSenhaComAoMenosUmaLetraMaiusculaValidaControllerTesteInvalido() {
		SenhaDTO senhaDTO = new SenhaDTO();
		senhaDTO.setSenha("");
		ResponseEntity<SenhaStatusDTO> resultado = validacaoController.validarSenha(senhaDTO);
	...
	@Test
	public void verificarSenhaComAoMenosUmaLetraMaiusculaTesteValido() {
		SenhaDTO senhaDTO = new SenhaDTO();
		senhaDTO.setSenha("AbTp9!fok");
	...
	@Test
	public void verificarSenhaComAoMenosUmaLetraMaiusculaTesteInvalido() {
		SenhaDTO senhaDTO = new SenhaDTO();
		senhaDTO.setSenha("abtp9!fok");
		SenhaStatusDTO resultado = validacaoSenhaService.validarRegrasSenha(senhaDTO);
