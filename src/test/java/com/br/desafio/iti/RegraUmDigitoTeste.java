...
public class RegraUmDigitoTeste {
	...
	@Test
	public void verificarSenhaComAoMenosUmDigitoTesteControllerValido() {
	...
	@Test
	public void verificarSenhaComAoMenosUmDigitoTesteControllerInvalido() {
		SenhaDTO senhaDTO = new SenhaDTO();
		senhaDTO.setSenha("");
		ResponseEntity<SenhaStatusDTO> resultado = validacaoController.validarSenha(senhaDTO);
	...
	@Test
	public void verificarSenhaComAoMenosUmDigitoTesteValido() {
		SenhaDTO senhaDTO = new SenhaDTO();
		senhaDTO.setSenha("AbTp9!fok");
	...
	@Test
	public void verificarSenhaComAoMenosUmDigitoTesteInvalido() {
		SenhaDTO senhaDTO = new SenhaDTO();
		senhaDTO.setSenha("");
		SenhaStatusDTO resultado = validacaoSenhaService.validarRegrasSenha(senhaDTO);
